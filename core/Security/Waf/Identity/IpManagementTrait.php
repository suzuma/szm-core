...
trait IpManagementTrait
{
    ...
    protected function rateLimit(): void
    {
        ...
        if ($count > WafConfig::RATE_LIMIT_PER_MINUTE) {
            $this->block("rate_limit", "requests_per_minute", (string)$count, $this->ip, true);
        }
    }
    ...
    {
        // Delegamos en IpResolver — fuente de verdad única compartida
        // con Application::resolveClientIp() para garantizar consistencia.
